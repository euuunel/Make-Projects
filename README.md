...
### Final Result
![Uploaded File in ASANA](Make_Portfolio/1_Automating_Xero_Report_Delivery_to_ASANA/ASANA.png)
...
### Full Workflow Overview
- Workflow
![Workflow Overview](Make_Portfolio/2_Auto_Sort_Gmail_Attachments_on_Drive/Auto_Sort_Gmail_Attachment.png)
- Logs Activity
![Logs in Google sheet](Make_Portfolio/2_Auto_Sort_Gmail_Attachments_on_Drive/File_attachments_from_Gmail_logs.png)
- Summary Notification
![Logs in Google sheet](Make_Portfolio/2_Auto_Sort_Gmail_Attachments_on_Drive/Sample_summary_notification_email.png)
